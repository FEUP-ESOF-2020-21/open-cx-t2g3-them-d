        ...
        body: SingleChildScrollView(
            child: Column(children: <Widget>[
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(color: Colors.white, fontSize: 20.0,  fontWeight: FontWeight.w500, fontFamily: 'Rubik',),
              ...
              Text(
                  ...
                  style: TextStyle(color: Color(0xFF6E96EF), fontSize: 20.0,  fontWeight: FontWeight.w400, fontFamily: 'Rubik',)
              ),
              ButtonTheme(
                minWidth: MediaQuery.of(context).size.width * 0.6,
                child: RaisedButton(
              ...
              Text(
                  ...
                  style: TextStyle(color: Color(0xFF5BBDB8), fontSize: 20.0,  fontWeight: FontWeight.w400, fontFamily: 'Rubik',)
              ),
              ButtonTheme(
                minWidth: MediaQuery.of(context).size.width * 0.6,
                child: RaisedButton(
